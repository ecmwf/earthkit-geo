...
- added methods :py:meth:`earthkit.geo.rotate.rotate` and :py:meth:`earthkit.geo.rotate.unrotate` to perform spehrical rotation. See the notebook example: :ref:`/examples/geo/rotate.ipynb`
