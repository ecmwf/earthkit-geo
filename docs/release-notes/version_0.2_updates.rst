...
- added methods :py:meth:`earthkit.geo.rotate.rotate` and :py:meth:`earthkit.geo.rotate.unrotate` to perform spehrical rotation. See the notebook example: :ref:`/how-tos/geo/rotate.ipynb`
